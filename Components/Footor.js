					...
					<div class="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
						<div class="lg:w-1/4 md:w-1/2 w-full px-4">
							<nav class="list-none mb-10">
								...
								<li>
									<a class="text-gray-600 hover:text-gray-800">
										<Link href="/Portflio"> Portflio</Link>
									</a>
								</li>
							</nav>
						</div>
						...
						<div class="lg:w-1/4 md:w-1/2 w-full px-4">
							<nav class="list-none mb-10">
								<li>
									<a class="text-gray-600 hover:text-gray-800">Address:Street 7B Hostel City ChakShezad Islambad Pakistan</a>
								</li>
								<li>
									<a class="text-gray-600 hover:text-gray-800">Phone:+923169089872</a>
								</li>
								<li>
									<a class="text-gray-600 hover:text-gray-800">Email:info@developercastle.com</a>
								</li>
							</nav>
						</div>
					</div>
